...
/**
 * ActivitiTest ：用于进行演示Activiti的首例程序，即描述如何在代码中实现学生进行请假申请，班主任审核，教务处审核
 *
 * @author Lv
 * @since 2018/8/9 15:28
 */
public class ActivitiTest {
  ...
  public void testStartProcessInstance(){
    ...
    processEngine.getRuntimeService()
        .startProcessInstanceById("leaveApply:1:4");  //这个是查看数据库中act_re_procdef表
  }
  /**
   * 完成请假申请
   */
  ...
  /**
   * 小明学校的班主任teacher查询当前正在执行任务
   */
  @Test
  public void testQueryTask(){
    //下面代码中的teacher，就是我们之前设计那个流程图中添加的班主任内容
    ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
